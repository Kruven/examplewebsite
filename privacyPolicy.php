...
<div class="contentArea">
    <ul class="pageContent">
        <li class="pageText">
            <h1>Privacy Policy <span style="font-size:16px">(Read Carefully)</span></h1>
            <p>
                This privacy policy sets out how "PC Repairs UK" uses and protects any information that you give 'PC Repairs UK' when you 
                use this website.
                <br><br>
                "PC Repairs UK" is committed to ensuring that your privacy is protected. Should we ask you to provide certain information 
                by which you can be identified when using this website, then you can be assured that it will only be used in accordance with 
                this privacy statement.
                <br><br>
                "PC Repairs UK" may change this policy from time to time by updating this page. You should check this page from time to 
                time to ensure that you are happy with any changes. This policy is effective from 05/06/2012.
            </p>
            ...
            <ul class="bulletPoints">
                <li><b>First Name & Surname</b></li>
                <li><b>E-mail & Telephone</b></li>
                <li><b>Demographic Information</b></li>
                <li><b>Other Information regarding Promotional/Marketing</b></li>
            </ul>

            <h3>What we do with the information we gather</h3>

            <p>We require this information to understand your needs and provide you with a better service, and in particular for the 
                following reasons:</p>

            <ul class="bulletPoints">
                <li><b>Internal record keeping.</b></li>
                <li><b>We may use the information to improve our products and services.</b></li>
                <li><b>We may periodically send promotional emails about new products, special offers or other information which we think 
                    you may find interesting using the email address which you have provided.</b></li>
                <li><b>From time to time, we may also use your information to contact you for market research purposes. We may contact you 
                    by email, phone, fax or mail. We may use the information to customise the website according to your interests.</b></li>
            </ul>
            ...
            <ul class="bulletPoints">
                <li><b>Whenever you are asked to fill in a form on the website, look for the box that you can click to indicate that you 
                    do not want the information to be used by anybody for direct marketing purposes</b></li>
                <li><b>If you have previously agreed to us using your personal information for direct marketing purposes, you may change 
                    your mind at any time by writing to or emailing us at unsubscribe@pcrepairsuk.com. Do this from the e-mail address 
                    you wish to be removed from for future marketing and promotional updates.</b></li>
            </ul>
            ...
            <p>
                ...
                will be payable. If you would like a copy of the information held on you please write to "PC Repairs UK, Unknown Street, 
                Somewhere, HXY 56Y".
                <br><br>
